...
// Δευτερεύοντες σύνδεσμοι (εργαλεία + νομικά) — δεν εμφανίζονται στο βασικό
// μοτίβο του footer, αλλά πρέπει να παραμείνουν προσβάσιμοι.
...
export default function Footer() {
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="wrap footer-secondary">
