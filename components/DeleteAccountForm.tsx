  ...
  return (
    <div style={{ marginTop: 48, paddingTop: 28, borderTop: "1px solid var(--line)" }}>
      ...
      <p style={{ fontSize: 13.5, color: "var(--muted)", lineHeight: 1.7, marginBottom: 18, maxWidth: "52ch" }}>
        Θα διαγραφούν μόνιμα ο λογαριασμός σου και το κελάρι σου. Δεν μπορεί να αναιρεθεί. Οι
        αξιολογήσεις σου δεν διαγράφονται — παραμένουν στην πλατφόρμα, χωρίς να συνδέονται πλέον με
        τον λογαριασμό σου. Για να επιβεβαιώσεις, πληκτρολόγησε το email του λογαριασμού σου ({email}).
      </p>
