    ...
    <div className="wrap page-head" style={{ paddingBottom: 80 }}>
      ...
      <section style={{ paddingLeft: 0, paddingRight: 0 }}>
        ...
        <p className="desc">
          ...
          εμφανίζουμε στο site. Αν διαγράψεις τον λογαριασμό σου, οι αξιολογήσεις σου δεν διαγράφονται
          — παραμένουν ως περιεχόμενο, αποσυνδεδεμένες από την ταυτότητά σου. Είσαι υπεύθυνος/η για την
          ακρίβεια όσων γράφεις. Δες την{" "}
