// Ανεβάζει τις πραγματικές φωτογραφίες ετικέτας του Gavalas Winery στο
...
const IMAGE_MAP: Record<string, string> = {
  "gavalas-santorini-assyrtiko": "Santorini_Gavalas_wines (1).png",
  "gavalas-santorini-natural-ferment": "santorini_natural_ferment.png",
  "gavalas-nychteri": "nykteri_gavalas_wines.png",
  "gavalas-enalia": "Enalia png.png",
  "gavalas-mavrotragano": "mavrotragano_gavalas_wines.png",
  "gavalas-vinsanto": "Vinsanto_gavalas_wines.png",
};
