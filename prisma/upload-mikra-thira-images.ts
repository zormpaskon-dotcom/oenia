// Ανεβάζει τις πραγματικές φωτογραφίες ετικέτας του Κτήματος Μικρά Θήρα στο
...
//
// Σημείωση: το "Santorini" δεν έχει φωτογραφία εδώ — το αρχείο Santorini.tif
// ήταν άδειο mockup ετικέτας (χωρίς πραγματικό σχέδιο/κείμενο).
...
const SOURCE_DIR = "/tmp/mikra_jpg";

const IMAGE_MAP: Record<string, string> = {
  "mikra-thira-terrasea": "TERRASEA NON VINTAGE.jpg",
  "mikra-thira-nykteri": "Nykteri.jpg",
  "mikra-thira-mandilaria": "Mandilaria Mikra Thira.jpg",
  "mikra-thira-vinsanto": "VINSANTO.jpg",
};
