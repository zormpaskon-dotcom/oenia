// Ανεβάζει τις φωτογραφίες ετικέτας της σειράς RAW (Oenops Wines) στο
// Vercel Blob. Crops από την επίσημη ομαδική φωτογραφία (raw_s.png) στο
// oenopswines.gr/el/raw/.
...
const SOURCE_DIR = "/tmp/oenops_raw_img";

const IMAGE_MAP: Record<string, string> = {
  "oenops-rawditis": "rawditis.jpg",
  "oenops-xinomavraw": "xinomavraw.jpg",
};
